        ...
        <section id="industries" className="py-24 bg-black text-white overflow-hidden">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { name: "Gourmet Food", desc: "Tea, spices, and luxury snacks in hermetically sealed tubes.", img: "https://images.unsplash.com/photo-1544787210-2213d84ad960?q=80&w=2070&auto=format&fit=crop" },
                { name: "Premium Electronics", desc: "Sleek, protective cylindrical casing for modern tech gadgets.", img: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=2070&auto=format&fit=crop" },
                { name: "Artisanal Crafts", desc: "Texture-rich, premium paper boxes for high-end boutique goods.", img: "https://images.unsplash.com/photo-1513519245088-0e12902e5a38?q=80&w=2070&auto=format&fit=crop" }
              ].map((item, i) => (
